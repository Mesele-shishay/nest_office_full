...
export function LoginHero() {
  return (
    <div className="flex-1 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 flex flex-col justify-between p-4 sm:p-6 md:p-8 lg:p-12 min-h-[30vh] sm:min-h-[35vh] lg:min-h-screen relative overflow-hidden">
      {/* Background Pattern */}
